...
/// </summary>
public class ServerSocketEvents
{
    /// <summary>
    ...
    public void CallClientConnectedEvent(object? sender, string clientIp) => this.ClientConnected?.Invoke(sender, new ClientConnectedEventArgs(clientIp));
    ...
    /// <param name="sender">Кто вызвал событие</param>
    /// <param name="clientIp">IP клиента</param>
    public void CallClientDisconnectedEvent(object? sender, string clientIp) => this.ClientDisconnected?.Invoke(sender, new ClientDisconnectedEventArgs(clientIp));
